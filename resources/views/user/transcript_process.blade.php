    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/breadcrumbs-bg.jpg');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
        ...
        <ol>
          ...
          <li class="white-text">Relevé de note</li>
        </ol>
        ...
        <div class="row gy-12">
          ...
          <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
            ...
            <ul class="list-unstyled">
              ...
              <li><i class="bi bi-check2"></i> <span>Scannez (prenez une photo claire) de votre carte d'étudiant </span></li>
              ...
              <li><i class="bi bi-check2"></i> <span>Rendez-vous dans Menu; accédez à la section SERVICES. Ensuite selectionnez RELEVE DE NOTE</span></li>

              <li><i class="bi bi-check2"></i> <span>Remplissez soigneusement le <a href="transcript_form.html"> formulaire</a> de demande
                de relevé note. Suivez les instructions  <br>jusqu'à l'etape de paiement </span></li>
