    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/breadcrumbs-bg.jpg');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
        ...
        <ol>
            ...
            <li class="white-text">Attestation de succès</li>
        </ol>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-12">
          ...
          <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
            ...
            <p>
              Pour pouvoir faire une demande d'attestation de succès, vous êtes appelé à procéder comme suit:
            </p>

            <ul class="list-unstyled">
             
              <li><i class="bi bi-check2"></i> <span>Scannez (prenez une photo claire) des relevé de notes de deux semestres </span></li>
              <li><i class="bi bi-check2"></i> <span> <a href="login.html">Connectez-vous</a> à votre compte; Rassurez-vous d'en avoir créer</span></li>
              ...
              <li><i class="bi bi-check2"></i> <span>Remplissez soigneusement le <a href="certificate_form.html"> formulaire</a> de demande
